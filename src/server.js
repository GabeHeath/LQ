...
export default function startServer(store) {
  ...
  // One could think of various ways of optimizing this (e.g. just sending the relevant subset, 
  // sending diffs instead of snapshots...), but this implementation has the benefit of being easy to write, 
